...
<html lang="en">
<head>
<link rel="stylesheet" href="my_first_stylesheet.css">
</head>
<body>
...
```
Hit ctrl + x to save and exit. Then find the file in the file explore (the app that looks like)

For extra credit try changing the colors to something different. A list of colors is in CSS_Colors.